...
值得注意的是，当前的 AI 大语言模型的训练集，几乎遍历了人类知识的庞大集合，使得它可以成为建立初步认知模型的有力工具。没事可以多问 AI 模型，可以帮助我们快速建立知识领域的初步框架、规划上述的 Roadmap，并获得基础概念的解答。但其本质仍是基于已有信息的组合，真正的整理与计划仍然需要你自身去和有经验的人一同完善和确认，并在行动中去做调整。
